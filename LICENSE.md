# Licenca de Uso Comunitario, Nao Comercial e Atribuicao

Copyright (c) 2026 Vitor Ferreira

## Permissao

Este projeto pode ser lido, copiado, adaptado e compartilhado sem fins lucrativos para estudo, documentacao, educacao e troca de experiencias na comunidade AWS, desde que:

- seja mantido o credito a este repositorio e aos autores das fontes originais;
- alteracoes relevantes sejam identificadas;
...
Fotos, audios, videos, slides, marcas, nomes, trechos de falas e links de terceiros continuam sujeitos aos direitos e licencas de seus respectivos titulares. Esta licenca nao concede permissao para re-hospedar ou reutilizar esses materiais fora do escopo autorizado por cada titular. A censura automatica de rostos e uma medida de privacidade, nao uma autorizacao de publicacao.

## AWS e marcas

AWS, Amazon Web Services e nomes de servicos sao marcas da Amazon Web Services, Inc. ou de suas afiliadas. Este projeto e independente, comunitario e nao e um produto oficial da AWS.
