...
| Areas de interesse | agentic-ai, Generative AI, Microsoft |
...
Sessão de live coding: começando com uma aplicação legada em .NET Framework, migrando para .NET moderno com AWS Transform e usando o Kiro para refatorar o código com vibe coding e desenvolvimento orientado a especificações. Veja o processo completo de modernização de ponta a ponta.
